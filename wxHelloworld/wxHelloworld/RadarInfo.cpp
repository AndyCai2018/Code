...
//  int orientation;
 ...
 // orientation = GetOrientation();
  //f ((orientation == ORIENTATION_HEAD_UP || m_previous_orientation == ORIENTATION_HEAD_UP) &&
